...
<body style="background-color:#FBFBFB;">
    ...
    <div id="plain">
        <p style="margin-left:1300px;font: 15px Arial, sans-serif;">
        <img src="https://www.gitam.edu/assets/images/spotlight/teacher-pointing-blackboard.svg" height=60 width=50 style="position:absolute;left:1230px"><br>
        <b>
